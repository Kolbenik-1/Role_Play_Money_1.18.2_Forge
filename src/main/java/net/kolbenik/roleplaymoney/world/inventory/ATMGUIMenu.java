...
import net.kolbenik.roleplaymoney.procedures.ATMGUIThisGUIIsClosedProcedure;
...
public class ATMGUIMenu extends AbstractContainerMenu implements Supplier<Map<Integer, Slot>> {
	...
	public ATMGUIMenu(int id, Inventory inv, FriendlyByteBuf extraData) {
		super(RolePlayMoneyModMenus.ATMGUI, id);
	...
	public void removed(Player playerIn) {
		...
		ATMGUIThisGUIIsClosedProcedure.execute(world, x, y, z, entity);
