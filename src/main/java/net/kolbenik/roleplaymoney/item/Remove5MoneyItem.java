...
import net.kolbenik.roleplaymoney.procedures.Remove5MoneyRightclickedProcedure;
import net.kolbenik.roleplaymoney.init.RolePlayMoneyModTabs;

public class Remove5MoneyItem extends Item {
	public Remove5MoneyItem() {
	...
	public InteractionResultHolder<ItemStack> use(Level world, Player entity, InteractionHand hand) {
		...
		Remove5MoneyRightclickedProcedure.execute(entity);
		return ar;
	}
}
